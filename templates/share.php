<div class="share-wrapper">
  ...
  <ul class="share-things">
    ...
    <li><a target="blank" href="https://twitter.com/home?status=<?php the_title(); ?>%20%7C%20<?php bloginfo( 'siteurl' ) ?><?php the_permalink(); ?>" class="ss-icon ss-social-circle ss-twitter"></a></li>
  </ul>
</div>